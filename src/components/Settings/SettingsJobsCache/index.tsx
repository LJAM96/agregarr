...
const messages: { [messageName: string]: MessageDescriptor } = defineMessages({
  ...
  'plex-delete-unlabelled-collections': 'Delete Unlabelled Collections',
  'plex-edition-manager': 'Edition Manager (Full)',
  'plex-edition-manager-incremental': 'Edition Manager (Incremental)',
