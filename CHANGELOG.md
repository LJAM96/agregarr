...
- **api:** fix caching of api clients causing settings to not reflect in sync ([553e99a](https://github.com/LJAM96/agregarr/commit/553e99a8a08fecfcbf2825a292208c5eb079a3cd))
- **badges:** extract badge data to common component, add placeholder creation badge ([3c4ca7c](https://github.com/LJAM96/agregarr/commit/3c4ca7c64c9186b2dd6cf9b69e0cf161e774bce0))
- **collection config:** prevents closing form when clicking outside of modal ([82a04d3](https://github.com/LJAM96/agregarr/commit/82a04d33fec6e2cfe3a91532d64ce9b8f6db275c)), closes [#237](https://github.com/LJAM96/agregarr/issues/237)
- **config:** fix incorrect variable check ([9cbc3b5](https://github.com/LJAM96/agregarr/commit/9cbc3b594a09eb996e2693da5d21724b991cb71b))
- **debug:** add export for config data ([31098b2](https://github.com/LJAM96/agregarr/commit/31098b2b1c81855865df9c19f1f1afb48e0e3cf5))
- **filtered hubs:** adds recently released episodes filtered hub ([5b0023d](https://github.com/LJAM96/agregarr/commit/5b0023de6812160cf31101f860b990461e91130e))
- **imdb:** fix tvMovie media type being categorised as tv ([162926a](https://github.com/LJAM96/agregarr/commit/162926a7985370ed458d2fe954cd6c4b20a559f3)), closes [#229](https://github.com/LJAM96/agregarr/issues/229)
- **item order:** fixes item ordering in plex collections ([8c94464](https://github.com/LJAM96/agregarr/commit/8c94464c17339b420e0446535e30bf4ed8484f38)), closes [#225](https://github.com/LJAM96/agregarr/issues/225)
- **job scheduling:** fixes cron parsing for following execution time ([7f0962e](https://github.com/LJAM96/agregarr/commit/7f0962e5fe4ecafa2f913e87db44e6510e2cda23))
- **language:** add Hungarian as language option (locale and TMDB) ([464825d](https://github.com/LJAM96/agregarr/commit/464825d28c19c94e9f9d1e3484ae46de7b70c9e1))
- **library:** fixes promotion/demotion not working for agregarr collections ([7d96b52](https://github.com/LJAM96/agregarr/commit/7d96b52f2578ac7d458bd83b8407a8a5d19e2ad7)), closes [#207](https://github.com/LJAM96/agregarr/issues/207)
- **migration:** moves app migration to inline typeORM ([f2e310d](https://github.com/LJAM96/agregarr/commit/f2e310dc98be14086f463292a04f0d3f353f49d0)), closes [#215](https://github.com/LJAM96/agregarr/issues/215)
- **missing item filtering:** fixes country/language exclusions ([74e4dab](https://github.com/LJAM96/agregarr/commit/74e4dabe497734c9b5b1888190925d5a473b950c)), closes [#262](https://github.com/LJAM96/agregarr/issues/262)
- **missing items filtering:** adds RT audience as missing item filter ([424c8f2](https://github.com/LJAM96/agregarr/commit/424c8f2347efc3bbc52cf79fbb1bbebc8b97feb9)), closes [#246](https://github.com/LJAM96/agregarr/issues/246)
- **multi source:** fixes incorrect library type ([4bcd1cc](https://github.com/LJAM96/agregarr/commit/4bcd1cc2c13d2c724d69f8c5e7a91ea72b3b0b16))
- **networks:** fix parsing of hyphenated lists ([f4acd17](https://github.com/LJAM96/agregarr/commit/f4acd171441dabd73fb40ed2b6e4af51ec5f860f)), closes [#259](https://github.com/LJAM96/agregarr/issues/259) [#263](https://github.com/LJAM96/agregarr/issues/263)
- **networks:** fixes multi-source networks not showing in preview ([173b353](https://github.com/LJAM96/agregarr/commit/173b35358b658ba4c1c9ffaa9d487d8fcfdfa824)), closes [#209](https://github.com/LJAM96/agregarr/issues/209)
- **overlay editor:** add text opacity for overlays ([c5af8b4](https://github.com/LJAM96/agregarr/commit/c5af8b422638b1468015d78ffef2bda06b0533ca))
- **overlays job:** migrate old default job to 3am default to avoid conflitc with collections sync ([5640152](https://github.com/LJAM96/agregarr/commit/56401528592886c8120fa1db1f3087b60d773fcb))
- **overlays:** add backend support for DoVi, add preset for HDR and DoVi ([b2e645b](https://github.com/LJAM96/agregarr/commit/b2e645bc95cad2b09952f9e2989edf6e2503e8a2)), closes [#183](https://github.com/LJAM96/agregarr/issues/183)
- **overlays:** add date formatting options for nextSeasonAirDate ([ea2d07b](https://github.com/LJAM96/agregarr/commit/ea2d07b74a6f55ef7ff142d6808dda038d968001)), closes [#231](https://github.com/LJAM96/agregarr/issues/231)
- **overlays:** add further date formats ([7b56890](https://github.com/LJAM96/agregarr/commit/7b568909e5c836f4fcfa6172f98a6e5c8ab9b201)), closes [#216](https://github.com/LJAM96/agregarr/issues/216)
- **overlays:** add support for various plex url formats ([22653c9](https://github.com/LJAM96/agregarr/commit/22653c9b212a373d92a472a0245a5d3559c3d004))
- **overlays:** adds condition for gap in awaiting download preset template ([192ed95](https://github.com/LJAM96/agregarr/commit/192ed954f82181218f4a695101dfe717a7eb3576))
- **overlays:** enable per library overlays sync ([57e3c5a](https://github.com/LJAM96/agregarr/commit/57e3c5a8044647cb27c008b8ec8ad235556cc02e)), closes [#218](https://github.com/LJAM96/agregarr/issues/218)
- **overlays:** ensure poster is locked ([136d0e9](https://github.com/LJAM96/agregarr/commit/136d0e92f3a1190d9c1f977696dbdaac0be17977))
- **overlays:** fix some variables not having correct operators ([73984f0](https://github.com/LJAM96/agregarr/commit/73984f0961eaed418523b2c6a3b67d624b3a88ca)), closes [#211](https://github.com/LJAM96/agregarr/issues/211)
- **overlays:** fix spaces in plex search query ([31b2650](https://github.com/LJAM96/agregarr/commit/31b2650648565f685c9c45c08349a1cff8fedd10)), closes [#217](https://github.com/LJAM96/agregarr/issues/217)
- **overlays:** fixes operator not updating when changing condition ([4c066b3](https://github.com/LJAM96/agregarr/commit/4c066b33fcfba73a2ab454b881059fbc3d6bf744)), closes [#210](https://github.com/LJAM96/agregarr/issues/210)
- **overlays:** update coming soon preset to include upcoming seasons ([c581536](https://github.com/LJAM96/agregarr/commit/c581536745dc1cf2f6af878a29e25d30db09e2d2))
- **overseerr:** fixes radarr/sonarr settings not being avaialable when only a single server is setup ([f579260](https://github.com/LJAM96/agregarr/commit/f5792601bc873a98fba08a65b22feaa104151b19)), closes [#154](https://github.com/LJAM96/agregarr/issues/154)
- **placeholders:** ensure placeholders are cleaned up in various scenarios ([788371c](https://github.com/LJAM96/agregarr/commit/788371c0f03119fa20ce42729590143c6eafa24d))
- **placeholders:** extract placeholder functions, refactor sources, overlays fixes ([4900554](https://github.com/LJAM96/agregarr/commit/4900554cc184b81df257b1940d377776cc8919b2))
- **placeholders:** fix incorrect parsing of path from plex ([2cb7d07](https://github.com/LJAM96/agregarr/commit/2cb7d07c91eebf73febea92a092a505794d508f4))
- **placeholders:** fix placeholders being deleted incorrectly ([10a43af](https://github.com/LJAM96/agregarr/commit/10a43afd0b7c638745689f69346564cd70179976))
- **placeholders:** fixes Days Ahead not being respected ([c30692c](https://github.com/LJAM96/agregarr/commit/c30692ce0cfc6af5c5420db11b06164d1721b4d4)), closes [#253](https://github.com/LJAM96/agregarr/issues/253) [#268](https://github.com/LJAM96/agregarr/issues/268)
- **plex libraries:** improved error handling. remove dual update paths ([691ae05](https://github.com/LJAM96/agregarr/commit/691ae055f8f1893717fc54416b100bb7b1e82d0b)), closes [#255](https://github.com/LJAM96/agregarr/issues/255)
- **posters:** add custom fonts support ([02999ac](https://github.com/LJAM96/agregarr/commit/02999acad6645b52e497ee2ae939e4d2542758b4)), closes [#219](https://github.com/LJAM96/agregarr/issues/219)
- **root folder:** add home button to go to root ([bc630a7](https://github.com/LJAM96/agregarr/commit/bc630a759e7c622a8d4933e59ef79e6a89e2b89c))
- **sync:** ensure individual sync does not run concurrently with main sync ([b911590](https://github.com/LJAM96/agregarr/commit/b911590fdf0700435526240b473448b117a740b6))
- **sync:** prevent collections sync and overlays sync running concurrently ([376d83c](https://github.com/LJAM96/agregarr/commit/376d83c1a2784eaa4b29f46ace5768f29b2f70ab))
- **tautulli:** fixes changes to tautulli minimum plays not being respected ([3eeaf27](https://github.com/LJAM96/agregarr/commit/3eeaf2704c036c774db1e724b1fcee4a74c7674f))
- **titles:** fix some title variables not working correctly ([0bcd709](https://github.com/LJAM96/agregarr/commit/0bcd709a806168efe0579e4e8767fb29c0e08c5e))
- **tmdb auto-franchise:** add grab missing item ([b2b7e3f](https://github.com/LJAM96/agregarr/commit/b2b7e3f3f349e340dbbb185571fcb4074ae30469)), closes [#205](https://github.com/LJAM96/agregarr/issues/205)
- **tmdb posters:** language option can now be selected per-library ([a3fec40](https://github.com/LJAM96/agregarr/commit/a3fec4027f184208e0327e944285964e7647eed1)), closes [#220](https://github.com/LJAM96/agregarr/issues/220)

### Features

- **internationalisation:** enable language picker and first few languages ([ad0e964](https://github.com/LJAM96/agregarr/commit/ad0e96400cf7f109a752daad69d6cde69a5a11f7))
- **overlays:** add overlays test modal, allowing testing of indivdual items ([6333c1a](https://github.com/LJAM96/agregarr/commit/6333c1a7a53e49c1a4f2ae42e30c70971cba0860)), closes [#212](https://github.com/LJAM96/agregarr/issues/212)
- **overlays:** add support for overlays based on maintainerr action ([858f793](https://github.com/LJAM96/agregarr/commit/858f7934a602bb2b9b528c3e2e237b86476d3394)), closes [#233](https://github.com/LJAM96/agregarr/issues/233)
- **sources:** add actor and director collections with seperators ([#198](https://github.com/LJAM96/agregarr/issues/198)) ([f91b7fa](https://github.com/LJAM96/agregarr/commit/f91b7faa804c9c0a49e4733f405bafbe70a44f16))
...
- **collections:** fixes stale hubs data creating collections ([54c215e](https://github.com/LJAM96/agregarr/commit/54c215e15e1352c536ea2e33f2dfff597b9b0f98))
- **coming soon:** add Deno for yt-dlp YouTube support ([8dd6dcb](https://github.com/LJAM96/agregarr/commit/8dd6dcbd18776e4a981009ec199d20d3edc2585e)), closes [#115](https://github.com/LJAM96/agregarr/issues/115)
- **coming soon:** adds Recently Added collection option to exclude Coming Soon placeholders ([9ef18b0](https://github.com/LJAM96/agregarr/commit/9ef18b0a849a308c1315096a38562d189443cb98)), closes [#115](https://github.com/LJAM96/agregarr/issues/115)
- **config:** enable wallpaper, theme, and summary for pre-existing collections ([785ba18](https://github.com/LJAM96/agregarr/commit/785ba18638f5e4563601bef3091fb5d8b224a91a))
- **config:** fixes modal closing when dragging outside of boundary ([b722fe0](https://github.com/LJAM96/agregarr/commit/b722fe00bdf001ec95767109ab808f2d4730e714)), closes [#114](https://github.com/LJAM96/agregarr/issues/114)
- **dashboard:** adds tautulli setup error ([54f6402](https://github.com/LJAM96/agregarr/commit/54f6402a09a7bf550d539ddfdf8b7e26f7127e82)), closes [#138](https://github.com/LJAM96/agregarr/issues/138)
- **discovery:** fix default hubs being relinked unecessarily ([9354de7](https://github.com/LJAM96/agregarr/commit/9354de7e0988dc78b06dd647c0cd2168ffc0bc13))
- **downloads:** adds more options to config form for downloads ([97f3668](https://github.com/LJAM96/agregarr/commit/97f366866a461291c207acd84fbfea5fc2138fe3)), closes [#106](https://github.com/LJAM96/agregarr/issues/106) [#131](https://github.com/LJAM96/agregarr/issues/131)
- **duplicate titles:** adds checks for duplicate titles for pre-existing collections ([3013a20](https://github.com/LJAM96/agregarr/commit/3013a2087dbc9754aaa9bf8edfc99139f46e3e11)), closes [#136](https://github.com/LJAM96/agregarr/issues/136)
- **exclusions:** adds mutual exclusions to multi-source ([a862d09](https://github.com/LJAM96/agregarr/commit/a862d0930c91548e1dfb31ec4ccfdde296f710b1)), closes [#115](https://github.com/LJAM96/agregarr/issues/115)
- **filtered hubs:** ensure existing filtered hubs get updated ([aaf0c50](https://github.com/LJAM96/agregarr/commit/aaf0c5084888e59ffc44a29db80f9fdd17286b89))
- **flix patrol:** fixes empty lists due to timezone/list publishing times ([87e31c6](https://github.com/LJAM96/agregarr/commit/87e31c6719f246e16f0c0cfb9b8bca3589706f03)), closes [#139](https://github.com/LJAM96/agregarr/issues/139)
- **flix patrol:** fixes table parsing for flix patrol ([783f7a8](https://github.com/LJAM96/agregarr/commit/783f7a85dba133987d214dd83e5441c4ade0338a)), closes [#169](https://github.com/LJAM96/agregarr/issues/169) [#172](https://github.com/LJAM96/agregarr/issues/172)
- **imdb custom lists:** fixes all items not being grabbed from imdb list ([2c7f65a](https://github.com/LJAM96/agregarr/commit/2c7f65af705e8f184aa0e3e565f4c90275e5f35b)), closes [#167](https://github.com/LJAM96/agregarr/issues/167)
- **letterboxd matching:** improves letterboxd fuzzy matching ([02e8b3e](https://github.com/LJAM96/agregarr/commit/02e8b3ea596da7035ff4f5369211b561714a10d4))
- **letterboxd:** fixes matching for items with inconsistent release year ([843c516](https://github.com/LJAM96/agregarr/commit/843c5161c8043c93c85e6f20d45d270beab5fe01)), closes [#116](https://github.com/LJAM96/agregarr/issues/116)
- **letterboxd:** fixes parsing of apostrophe ([bd92c80](https://github.com/LJAM96/agregarr/commit/bd92c8047daf21a51d20fe4887b493ef03bdc3d1)), closes [#199](https://github.com/LJAM96/agregarr/issues/199)
- **linking collections:** fixes name being propgated across all hubs when linking ([b0320e2](https://github.com/LJAM96/agregarr/commit/b0320e218e8ae6f178ea5a09bfbbf4c174c03436))
- **linking hubs:** fixes corrupted linkId ([49666ee](https://github.com/LJAM96/agregarr/commit/49666ee7b49877d31e12aa2463ade3b40c079e31))
- **metadata:** fixes wallpaper, theme, and summarry not applying to multi-source collections ([c1150b0](https://github.com/LJAM96/agregarr/commit/c1150b0f8020816e5933e5a9e08c399edc91ed84)), closes [#194](https://github.com/LJAM96/agregarr/issues/194)
- **migrations:** fix broken migrations ([dde3bbd](https://github.com/LJAM96/agregarr/commit/dde3bbd8865afaf28de785dbe63a33ea3bd2e069))
- **minor fixes:** add editionTitle, remove duplicate poster storage intialisation ([0551af0](https://github.com/LJAM96/agregarr/commit/0551af0027b16096573515a98d3c1b5601bda678))
- **missing collections:** adds auto-delete for missing pre-existing collections ([7852b7a](https://github.com/LJAM96/agregarr/commit/7852b7ac7097d5f8fbf464c525cc4b9624e3da6f)), closes [#195](https://github.com/LJAM96/agregarr/issues/195)
- **networks top 10:** fixes best match being overriden by library type ([7ee89b6](https://github.com/LJAM96/agregarr/commit/7ee89b6738e26b3ca13d2fc58df812bceec174ec)), closes [#172](https://github.com/LJAM96/agregarr/issues/172)
- **overlays:** add 25% opacity overlay for placeholder items ([a257322](https://github.com/LJAM96/agregarr/commit/a25732281a9c1a3b2aa67aa1f0d0aab2742ad42b)), closes [#115](https://github.com/LJAM96/agregarr/issues/115) [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** add corner radius options ([e9f8816](https://github.com/LJAM96/agregarr/commit/e9f8816835171fd01dd4aa8c776e9b24f5b06540)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** add daysAgoNextSeason and fix AWAITING DOWNLOAD preset template ([9d2f6ae](https://github.com/LJAM96/agregarr/commit/9d2f6aec8fec305aeb4fa34cb9e8ddc5eaef65fc))
- **overlays:** add live placeholder tracking, seperate out releaseDate ([6cda7b8](https://github.com/LJAM96/agregarr/commit/6cda7b8347252a45ccb040a88972d7becb6768ba)), closes [#175](https://github.com/LJAM96/agregarr/issues/175) [#178](https://github.com/LJAM96/agregarr/issues/178) [#179](https://github.com/LJAM96/agregarr/issues/179)
- **overlays:** add preset templates, refine UI ([428a0a7](https://github.com/LJAM96/agregarr/commit/428a0a742666b841282b502474f955e65cbd8d8e))
- **overlays:** add TMDB TV series status conditions, variables and preset ([dea44dd](https://github.com/LJAM96/agregarr/commit/dea44dd649b664a7acaf6b8c4858e9217eb3ba63)), closes [#171](https://github.com/LJAM96/agregarr/issues/171)
- **overlays:** add TZ offset for release date calculation ([e1a7880](https://github.com/LJAM96/agregarr/commit/e1a7880930e16a9c177e93a3d8a6d5b7a61a1a90)), closes [#115](https://github.com/LJAM96/agregarr/issues/115) [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** adds option to use plex posters as base overlay poster ([9df021a](https://github.com/LJAM96/agregarr/commit/9df021a1b6081c29be494b5c6a466e0c76ab9bef)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** adds poster reset option ([a6eef5a](https://github.com/LJAM96/agregarr/commit/a6eef5a8bea79c9680aa071e9aa806a860ed3ca7)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** apply overlays during sync now skips if no overlays configured ([f2623e6](https://github.com/LJAM96/agregarr/commit/f2623e63e95a005851124938549f5b283a01e10c)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** cleanup overlays from config on deletion ([ddfc86e](https://github.com/LJAM96/agregarr/commit/ddfc86ea4f1451104ab422fed018f5ef3614846f)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** fix poster source setting not saving when re downloading ([5296c48](https://github.com/LJAM96/agregarr/commit/5296c48f3bde9531f87d0af56192524bc49d68a4))
- **overlays:** fixes imdb top 250 conditions, monitored (placeholder) conditions ([0aa2296](https://github.com/LJAM96/agregarr/commit/0aa2296bc6dcb7238f7ec2a6ef6990c2131fcdbc)), closes [#115](https://github.com/LJAM96/agregarr/issues/115) [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** fixes overlays appearing incorrectly ([9d33b13](https://github.com/LJAM96/agregarr/commit/9d33b1357ec861dd65ff6b53b4337a1094b30f81)), closes [#173](https://github.com/LJAM96/agregarr/issues/173)
- **overlays:** fixes overlays not rendering in preview ([203e075](https://github.com/LJAM96/agregarr/commit/203e075905df1fe4cd477de6332ba3a635616e95)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** fixes some fonts not working ([630e04a](https://github.com/LJAM96/agregarr/commit/630e04a8a8be649cd338c66c1c8a9c9dd369d051)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overlays:** refactor types, fix overlays not receiving correct source, minor fixes ([fea363d](https://github.com/LJAM96/agregarr/commit/fea363dc3ea750a89bcd38c1d06b4ef2d4027dae))
- **overlays:** remove incorrect application of overlays ([43b8e05](https://github.com/LJAM96/agregarr/commit/43b8e0549cf8ffa9c66332e7f8ef088f5a55ca5f))
- **overlays:** rework conditions to more logical structure, multiple overlays fixes ([92d6318](https://github.com/LJAM96/agregarr/commit/92d63185f0d9a0c3b18a545b2169a17601af2e28)), closes [#115](https://github.com/LJAM96/agregarr/issues/115) [#128](https://github.com/LJAM96/agregarr/issues/128) [#144](https://github.com/LJAM96/agregarr/issues/144)
- **overseerr:** fixes overseerr userID being saved as undefined on failure, add debugging ([59f498a](https://github.com/LJAM96/agregarr/commit/59f498a1e244e856aa427d87036b16b9baa13016)), closes [#73](https://github.com/LJAM96/agregarr/issues/73)
- **overseerr:** fixes smart collections not having posters applied ([ac5e74b](https://github.com/LJAM96/agregarr/commit/ac5e74b5190f8bf99fbd83f55bddf69b6f0354da))
- **overseerr:** server, root folder, and profiles can now be selected ([e4738ed](https://github.com/LJAM96/agregarr/commit/e4738ed4e226d52afc3f9b587f77ffb68b7e0242)), closes [#131](https://github.com/LJAM96/agregarr/issues/131)
- **placeholders:** add placeholder cleanup to quick collection sync ([7739fa6](https://github.com/LJAM96/agregarr/commit/7739fa61f305a197675a3fcb47262760846018b9))
- **placeholders:** adds correct shared filtering function for tmdb coming soon ([e04518d](https://github.com/LJAM96/agregarr/commit/e04518d562e11ccb9cbc21a74aa11320cbd666f4))
- **placeholders:** update placeholder edition to Trailer ([d108891](https://github.com/LJAM96/agregarr/commit/d1088914c427a5940c2f220ac9048534b8298129))
- **plex libraries:** fixes plex libraries not saving on passive discovery ([9a8ffb9](https://github.com/LJAM96/agregarr/commit/9a8ffb96b64bbb2c9aec8620dd8c4fec8ff18f95))
- **plex user restrictions:** fixes live tv setting being reset when updating label restrictions ([f37cc1e](https://github.com/LJAM96/agregarr/commit/f37cc1e670aa6e506ece9ecb17010381f8c0edff)), closes [#145](https://github.com/LJAM96/agregarr/issues/145)
- **poster editor:** change poster editor from fabric.js to react-konva ([ee0dd5d](https://github.com/LJAM96/agregarr/commit/ee0dd5d7c81e08851cf1f8511bec9a12478e7b30)), closes [#115](https://github.com/LJAM96/agregarr/issues/115)
- **poster overlays:** multiple overlays fixes ([435bcdf](https://github.com/LJAM96/agregarr/commit/435bcdfc031b55af186151435b1efef8e9dcb9af)), closes [#168](https://github.com/LJAM96/agregarr/issues/168) [#115](https://github.com/LJAM96/agregarr/issues/115) [#144](https://github.com/LJAM96/agregarr/issues/144)
- **poster storage:** add temp cleanup, add usage checker for posters before deletion ([da31ec4](https://github.com/LJAM96/agregarr/commit/da31ec4e4509798ed23823e8c9d516ee58b1fe24))
- **poster templates:** fixes radial gradient background option ([f436b2f](https://github.com/LJAM96/agregarr/commit/f436b2fb987621f58de5f9fa3976926cc9ada20f)), closes [#133](https://github.com/LJAM96/agregarr/issues/133)
- **posters:** fixes slow lookup for coming soon items, adds plex poster to cleanup ([12abba4](https://github.com/LJAM96/agregarr/commit/12abba4e1101ad96fcdc7262deee9ce1dad9e442))
- **posters:** revert null poster fallback for TMDB ([366b2a2](https://github.com/LJAM96/agregarr/commit/366b2a2ade3a88c5a7ba66f43bbef43d16a76add)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **radarr/sonarr list exclusions:** updates endpoints (non-paginated now deprecated) ([07f6ac1](https://github.com/LJAM96/agregarr/commit/07f6ac174f27628e6b07dc8687aa0eda52f436dc)), closes [#163](https://github.com/LJAM96/agregarr/issues/163)
- **ratings:** iMDb TV show ratings added, RT fallback added ([9b44106](https://github.com/LJAM96/agregarr/commit/9b44106c8e18342329cd34cfc68ffdb5d7f61ccf)), closes [#130](https://github.com/LJAM96/agregarr/issues/130)
- **reset:** adds reset button to Settings -> General ([0c7ae30](https://github.com/LJAM96/agregarr/commit/0c7ae30cc0660b2c5385c9effedc728a746b4116)), closes [#117](https://github.com/LJAM96/agregarr/issues/117)
- **saved posters:** refactor of poster system with database tracking and automatic discovery ([9debc2d](https://github.com/LJAM96/agregarr/commit/9debc2d3e393639a3d0b7f461151c071d4190f8b))
- **smart collections:** adds max items for smart collections ([d8e8183](https://github.com/LJAM96/agregarr/commit/d8e8183741ebb4bd6610477825793e1deab3c6f6))
- **smart collections:** adds recently released filtered hubs ([c238da9](https://github.com/LJAM96/agregarr/commit/c238da9d8762a406df4cfda5ff9270f563e7e318)), closes [#128](https://github.com/LJAM96/agregarr/issues/128) [#115](https://github.com/LJAM96/agregarr/issues/115)
- **smart collections:** fixes smart collections feature not working for multi source collections ([6f8c07d](https://github.com/LJAM96/agregarr/commit/6f8c07d58e6e9d02d941ab85363946432f50da87)), closes [#137](https://github.com/LJAM96/agregarr/issues/137)
- **sonarr/radarr:** add options for monitoring, search, and season folders ([ac881c7](https://github.com/LJAM96/agregarr/commit/ac881c729a9e8734bcfcbd9ce3b27357a7e7a69f)), closes [#153](https://github.com/LJAM96/agregarr/issues/153)
- **sonarr:** add season folders option to config ([2a51f96](https://github.com/LJAM96/agregarr/commit/2a51f96b9b87b68f6eda8959cc6b423bf354e5a0)), closes [#153](https://github.com/LJAM96/agregarr/issues/153)
- **sonarr:** fixes missing anime option from sonarr settings ([007a5c1](https://github.com/LJAM96/agregarr/commit/007a5c1968df59d8c15f044b06ff659b211a75c2)), closes [#126](https://github.com/LJAM96/agregarr/issues/126)
- **sonarr:** fixes seasons not being monitored ([d015ca2](https://github.com/LJAM96/agregarr/commit/d015ca2703e486722e6179154191d29ca7253d43)), closes [#160](https://github.com/LJAM96/agregarr/issues/160) [#153](https://github.com/LJAM96/agregarr/issues/153)
- **tmdb:** adds networks and companies support for custom lists ([effa172](https://github.com/LJAM96/agregarr/commit/effa17284019e34169519edc60ed913e91383c43))
- **trakt:** adds recommended to multi-source, add OAuth setup validation ([2063242](https://github.com/LJAM96/agregarr/commit/2063242bac13094b60d4b13f59b3c8fc6b2d775d))
- **unwatched:** unwatched collections now create smart collections based off labels ([4d5c600](https://github.com/LJAM96/agregarr/commit/4d5c600627570bcb7596b2730d500d5eed31747b)), closes [#137](https://github.com/LJAM96/agregarr/issues/137) [#134](https://github.com/LJAM96/agregarr/issues/134)

### Features

- **background, theme, summary:** adds background, theme, and summary to config form ([3660622](https://github.com/LJAM96/agregarr/commit/36606225e584e1fea4e3b44a3ec916363e7f565f)), closes [#63](https://github.com/LJAM96/agregarr/issues/63)
- **bulk edit:** collections can now be edited in bulk ([7a5fe94](https://github.com/LJAM96/agregarr/commit/7a5fe94259846c4a6937ed2988ba9277ee03073f)), closes [#124](https://github.com/LJAM96/agregarr/issues/124)
- **exclusions:** adds collection mutual exclusion ([2ac987a](https://github.com/LJAM96/agregarr/commit/2ac987a832e734a949b2dbade44fb6ac7152e815)), closes [#156](https://github.com/LJAM96/agregarr/issues/156)
- **imdb rating filtering:** missing items can now be filtered by IMDb ratings ([789274d](https://github.com/LJAM96/agregarr/commit/789274d47df10574f416f30cad8b8e093a900fe2)), closes [#130](https://github.com/LJAM96/agregarr/issues/130)
- **item ordering:** lists can now be ordered by IMDb ratings ([6c4b230](https://github.com/LJAM96/agregarr/commit/6c4b230d55185c7affc0e551646bd5c120e570fd)), closes [#39](https://github.com/LJAM96/agregarr/issues/39)
...
- **missing items filtering:** adds language filter, adds exclude/exclude options ([5052cc2](https://github.com/LJAM96/agregarr/commit/5052cc29bf7dff456c20b3da292416fc07457e38)), closes [#111](https://github.com/LJAM96/agregarr/issues/111)
- **missing items:** season priority can now be selected when grabbing missing items ([cdcac39](https://github.com/LJAM96/agregarr/commit/cdcac397f0cc01cf8412a126acc3271c70389d06)), closes [#83](https://github.com/LJAM96/agregarr/issues/83)
- **placeholders:** create placeholders for missing items from any list ([6a757d8](https://github.com/LJAM96/agregarr/commit/6a757d806b0491560ccfe0a86bcd4aa5d5b130b7)), closes [#115](https://github.com/LJAM96/agregarr/issues/115) [#128](https://github.com/LJAM96/agregarr/issues/128)
- **plex metadata:** adds hashing system for posters, wallpapers, and themes ([f459595](https://github.com/LJAM96/agregarr/commit/f459595da4693410d6eb5487451df12159866f8d)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **plex watchlist:** adds plex watchlist grabbing via overseerr and radarr/sonarr ([f13bba0](https://github.com/LJAM96/agregarr/commit/f13bba07636c116a18276b5c1175343df9b49598))
- **poster languages:** adds option for poster languages under Settings -> General ([a017de4](https://github.com/LJAM96/agregarr/commit/a017de4ea70015782541e27e350c5e3871bb3669)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **poster overlays:** poster Overlays for individual items can now be created ([de8ed92](https://github.com/LJAM96/agregarr/commit/de8ed928fe54286d9e0c299893b93d0ee839da66)), closes [#144](https://github.com/LJAM96/agregarr/issues/144) [#115](https://github.com/LJAM96/agregarr/issues/115) [#128](https://github.com/LJAM96/agregarr/issues/128)
- **poster sources:** adds local poster source option ([9e15a66](https://github.com/LJAM96/agregarr/commit/9e15a66ab717c9640cfd12fcfd3f2de494dc4d28)), closes [#144](https://github.com/LJAM96/agregarr/issues/144)
- **poster templates:** collection poster templates can now be used for pre-existing collections ([8c9db85](https://github.com/LJAM96/agregarr/commit/8c9db854b5deb353923820e427710b0d4f3964d3)), closes [#118](https://github.com/LJAM96/agregarr/issues/118)
- **quick sync:** adds quick sync for collections and overlays ([c8fdc7b](https://github.com/LJAM96/agregarr/commit/c8fdc7b1ac09ea607e835723d3978cb03872e87a))
- **rt rating filtering:** missing items can now be filtered by Rotten Tomatoes ratings ([178d9f7](https://github.com/LJAM96/agregarr/commit/178d9f7482474634d6d09395891f1d3c1effd266)), closes [#119](https://github.com/LJAM96/agregarr/issues/119)
- **sources:** new Coming Soon Collection - Creates collection based of monitored/upcoming items ([d1e7dc5](https://github.com/LJAM96/agregarr/commit/d1e7dc5c24402b6f36e8051d91e27afa52b7c396)), closes [#115](https://github.com/LJAM96/agregarr/issues/115)
- **tmdb franchise:** adds auto TMDB franchise collections ([6083a79](https://github.com/LJAM96/agregarr/commit/6083a79f061bf86093331584ade20c48597a19c4)), closes [#129](https://github.com/LJAM96/agregarr/issues/129)
- **trakt:** add recommendations collection type ([#193](https://github.com/LJAM96/agregarr/issues/193), [#197](https://github.com/LJAM96/agregarr/issues/197)) ([df99edd](https://github.com/LJAM96/agregarr/commit/df99edd80790cdfdd233e9fc5a69b3a36cdb4fdf))
- **v2.0.0:** bump v2.0.0 ([453faa7](https://github.com/LJAM96/agregarr/commit/453faa7b49f2928a8daee343ec471c31b70b23ce))
